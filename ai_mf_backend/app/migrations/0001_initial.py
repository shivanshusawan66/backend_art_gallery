        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "gender",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.PROTECT, to="app.gender"
                    ),
                ),
                (
                    "marital_status",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.PROTECT,
                        to="app.investmentamountperyear",
                    ),
                ),
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.PROTECT,
                        to="app.monthlysavingcapacity",
                    ),
                ),
                (
                    "occupation",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.PROTECT, to="app.occupation"
                    ),
                ),
                (
                    "user",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "response",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, to="app.response"
                    ),
                ),
                (
                    "section",
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                "indexes": [
                    ...
                    models.Index(
                        fields=["phone_number"], name="user_contac_phone_n_d5ce5e_idx"
                    ),
                ],
            },
        ),
