...
from ai_mf_backend.models.v1.database.contact_message import ContactMessage, ContactMessageFundCategory
...
@router.get("/options_contact_message_fund_category",
