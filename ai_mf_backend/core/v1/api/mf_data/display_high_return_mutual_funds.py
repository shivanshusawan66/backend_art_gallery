...
from ai_mf_backend.models.v1.api.display_high_return_mutual_funds import (
    HighReturnMutualFundsResponse,
)
...
async def get_high_return_funds(
    ...
    try:
        ...
        result_query = ordered_query.values(
            "schemecode", "total", "_1yrret", "asset_type", "s_name"
        )
