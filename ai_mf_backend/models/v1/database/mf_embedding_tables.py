...
class MFMarker(SoftDeleteModel):
    section_id = models.ForeignKey(
        Section, on_delete=models.PROTECT, db_column="section_id"
    )
...
class MFResponse(SoftDeleteModel):
    ...
    option_id = models.ForeignKey(
        MFMarkerOptions, on_delete=models.PROTECT, db_column="option_id"
    )
    section_id = models.ForeignKey(
        Section, on_delete=models.PROTECT, db_column="section_id"
    )
...
class MarkerWeightsPerMutualFund(SoftDeleteModel):
    scheme_code = models.IntegerField()
    marker = models.ForeignKey(MFMarker, on_delete=models.PROTECT)
