    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('add_date', models.DateTimeField(auto_now_add=True)),
                ('update_date', models.DateTimeField(auto_now=True)),
                ('condition', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='ai_mf_backend.allowed_response')),
                ('dependent_question', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='dependent_question', to='ai_mf_backend.question')),
                ('question', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='main_question', to='ai_mf_backend.question')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            name='question',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='ai_mf_backend.question'),
        ),
        migrations.AddField(
            model_name='question',
            name='section',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='ai_mf_backend.section'),
        ),
        migrations.AddField(
            model_name='allowed_response',
            name='section',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('add_date', models.DateTimeField(auto_now_add=True)),
                ('update_date', models.DateTimeField(auto_now=True)),
                ('annual_income', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, to='ai_mf_backend.annualincome')),
                ('investment_amount_per_year', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, to='ai_mf_backend.investmentamountperyear')),
                ('monthly_saving_capacity', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, to='ai_mf_backend.monthlysavingcapacity')),
                ('occupation', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, to='ai_mf_backend.occupation')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='ai_mf_backend.usercontactinfo')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('add_date', models.DateTimeField(auto_now_add=True)),
                ('update_date', models.DateTimeField(auto_now=True)),
                ('gender', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, to='ai_mf_backend.gender')),
                ('marital_status', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, to='ai_mf_backend.maritalstatus')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='ai_mf_backend.usercontactinfo')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('add_date', models.DateTimeField(auto_now_add=True)),
                ('update_date', models.DateTimeField(auto_now=True)),
                ('question', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='ai_mf_backend.question')),
                ('response', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='ai_mf_backend.allowed_response')),
                ('section', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='ai_mf_backend.section')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='ai_mf_backend.usercontactinfo')),
            ],
            options={
