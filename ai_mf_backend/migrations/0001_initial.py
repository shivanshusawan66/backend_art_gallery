# Generated by Django 5.1.5 on 2025-03-20 18:55
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('blogcard_image', models.ImageField(blank=True, null=True, upload_to='blogcard_images/')),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ...
                ('user', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='ai_mf_backend.usercontactinfo')),
            ],
            options={
